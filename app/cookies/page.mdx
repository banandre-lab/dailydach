...
This Cookie Policy explains how DailyDach ("we," "our," or "us") uses cookies and similar tracking technologies on our website at dailydach.com (the "Platform" or "Site").

This Cookie Policy should be read together with our **Privacy Policy** [dailydach.com/privacy], which provides comprehensive information about how we collect, use, and protect your personal data.
...
**First-Party Cookies:**
- Set by dailydach.com directly
- Used for Platform functionality and analytics

**Third-Party Cookies:**
- Set by domains other than dailydach.com (e.g., google.com, cloudflare.com)
...
- `session_id` - dailydach.com - Maintains your browsing session - Session - First-party
- `auth_token` - dailydach.com - Authenticates logged-in users - 30 days - First-party
- `csrf_token` - dailydach.com - Prevents cross-site request forgery attacks - Session - First-party
- `load_balancer` - dailydach.com - Distributes server load - Session - First-party
- `cookie_consent` - dailydach.com - Stores your cookie consent preferences - 12 months - First-party
...
We use Google Analytics and Cloudflare Analytics for analytics.
...
- `analytics_session` - dailydach.com - Internal analytics tracking - 30 minutes - First-party
...
- Adjusting cookie preferences at dailydach.com/cookies
...
- `language` - dailydach.com - Remembers your language preference - 12 months - First-party
- `theme` - dailydach.com - Remembers light/dark mode preference - 12 months - First-party
- `layout_pref` - dailydach.com - Stores layout preferences - 6 months - First-party
...
**Third-Party Cookies:**
Social media plugins may set cookies. We cannot control cookies set by third-party social media plugins. These are subject to the privacy policies of the respective platforms.

**Privacy Notice:**
We cannot control cookies set by third-party social media plugins. These are subject to the privacy policies of the respective platforms.
...
**First Visit:**
When you first visit dailydach.com, you will see a cookie consent banner with the following options:
...
**See our Privacy Policy** [dailydach.com/privacy] Section 7 for detailed information about international data transfers.
...
Contact privacy@dailydach.com for questions about cookie data transfers.
...
- Contact us immediately at privacy@dailydach.com
...
**Exercising Rights:**
- **Cookie preferences:** Use our Cookie Preference Center [dailydach.com/cookies]
- **Delete cookies:** Use browser settings (Section 7)
- **Data subject rights:** Contact privacy@dailydach.com

See our **Privacy Policy** [dailydach.com/privacy] Section 9 for detailed information about your data protection rights.
...
See our **Privacy Policy** [dailydach.com/privacy] Section 10 for complete contact information.
...
Manage your cookie preferences: [dailydach.com/cookies]
...
**First-Party Cookie:** Set by the domain you're visiting (dailydach.com)
