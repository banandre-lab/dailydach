...
export function CategoriesLiquidBridge({
  categories,
}: CategoriesLiquidBridgeProps) {
    ...
    <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative">
        ...
        <div className="absolute inset-0 pointer-events-none hidden lg:block">
          ...
          >
            <path
              d="M200,150 C400,150 400,400 600,400"
              stroke="currentColor"
              strokeWidth="2"
              fill="none"
            ...
            />
            <path
              d="M600,400 C800,400 800,150 1000,150"
              stroke="currentColor"
              strokeWidth="2"
              fill="none"
              className="text-primary"
          ...
          >
            <Link href={`/${category.slug}`} className="block group h-full">
              <div
                ...
                ${
                  index === 0
                    ? "lg:col-span-2 lg:row-span-2 bg-gradient-to-br from-primary/20 to-accent/20"
                    : "bg-white/5"
                }
              `}
              >
