//////////////////////////////////////////////
// source https://github.com/faisalman/detect-europe-js/blob/main/src/index.ts
//////////////////////////////////////////////
...
const EEA_TIMEZONE = [...EU_TIMEZONE, ...EEA_EFTA_TIMEZONE];

const EFTA_TIMEZONE = [TIMEZONE.SWITZERLAND.ZURICH, ...EEA_EFTA_TIMEZONE];
...
const isTimezoneIn = (tz: string[]): boolean =>
  typeof window !== "undefined" &&
  window?.Intl?.DateTimeFormat &&
  tz.includes(Intl.DateTimeFormat().resolvedOptions().timeZone);
